...
<script>
	export default{
		...
		mounted(){
      this.$http.get("./data/girl.json")
      .then((res)=>{
        this.rotationGirl = res.data.girlList.rotationGirl
        this.hotGirl = res.data.girlList.hotGirl
        this.freeGirl = res.data.girlList.freeGirl
        this.listBtnNameGirl = res.data.girlList.listBtnNameGirl
        this.rankListGirl = res.data.girlList.rankListGirl
        this.NewBookGirl = res.data.girlList.NewBookGirl
        this.EndBookGirl = res.data.girlList.EndBookGirl
        this.TypeBtnNameGirl = res.data.girlList.TypeBtnNameGirl
        this.typeListGirl01 = res.data.girlList.typeListGirl01
        this.TypeBtnNameGirl02 = res.data.girlList.TypeBtnNameGirl02
        this.typeListGirl02 = res.data.girlList.typeListGirl02
        this.themeGirl = res.data.girlList.themeGirl
      })
