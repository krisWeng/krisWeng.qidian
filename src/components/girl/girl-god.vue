	...
	<main id="girl-god">
		...
		<header>
			<ul class="girlgod-ul">
				...
				<li class="girl-god-link">
					<router-link to="/boy-god" class="girlgodnav-btn">
						男生
					</router-link>
					<router-link to="/girl-god" class="girlgodnav-btn">
						女生
					</router-link>
				</li>
				<li class="girl-god-icon">
					<!-- 搜索 -->
...
<style>*{
	...
	.girl-god-link .router-link-exact-active{
		background: #ED424B;
		color: #fff;
	}
	/* icon */
