	...
	<main id="girl-free">
		...
		<header>
			<ul class="girlfree-ul">
				...
				<p class="header-p">免费</p>
				<li class="girl-free-link">
					<router-link to="/boy-free" class="girlfreenav-btn">
						男生
					</router-link>
					<router-link to="/girl-free" class="girlfreenav-btn">
						女生
					</router-link>
				</li>
				<li class="girl-free-icon">
					<!-- 搜索 -->
		...
		<div class="module">
			...
			<div class="slide">
				<ol class="slide-ol">
					<li v-for="(item,index) in NowFree" :key="index">
		...
		<div class="module">
			...
			<div class="slide">
				<ol>
					<li v-for="(item,index) in PublicBook" class="NewBook-li" :key="index">
		...
		<div class="module">
			...
			<div class="slide">
				<ol>
					<li v-for="(item,index) in TheNewBook" class="NewBook-li" :key="index">
						<div class="NewBook-All">
							<img :src="item.pic" class="Book-img">
							<div class="NewBook-cont">
								<h4 class="NewBook-title">{{item.title}}</h4>
...
<style>*{
	...
	.girlfreenav-btn:nth-child(1){
		border-radius: 0.25rem 0 0 0.25rem;

	}
	.girlfreenav-btn:nth-child(2){
		border-radius: 0 0.25rem 0.25rem 0;
		margin-left: -0.5rem;
	}
	.girl-free-link .router-link-exact-active{
		background: #ED424B;
		color: #fff;
	}
	/* icon */
