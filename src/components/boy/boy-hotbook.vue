	...
	<main id="boy-hotbook">
				...
				<div class="bookIntro-one">
					...
					<div class="book-cell">
						...
						<div class="box-score">
							...
							<span class="grade">8.8分/590人评过</span>
						</div>
						<p class="hotbook-type">都市/都市异能</p>
						<p class="hotbook-type">471.25万字<span>|</span>连载</p>
					</div>
				</div>
		...
		<div class="book-msg">
			<span class="book-synopsis">
				一个打架不要命,无节操无底线的小痞子，意外穿越到平行空间，摇身变成了一名重案组探员。巨大的身份转换，让他把警局搞得鸡飞狗跳。然而，一个邪门的奇遇系统，却让他屡破奇案，成为了一名个性张狂的痞子神探！PS：老旷出品，质量可靠，童叟无欺。书友群：194525098。全订群：12381865。
			</span>
			<div class="book-list">
				<span class="book-list-one">目录</span>
				<div>
					<p>3小时前<span>·</span>连载至第1975章 终极博弈（四）</p>
					<svg class="icon" aria-hidden="true">
		...
		<div class="book-fans">
			<div class="book-list">
				...
				<div>
					<p style="font-size: 1.125rem;margin-right: 0.25rem;">70.13万</p>
					<svg class="icon" aria-hidden="true">
						<use xlink:href="#icon-tiaozhuanqianwangyoujiantouxiangyouxiayibuxianxing"></use>
					</svg>
				</div>
					...
					<li class="PlatinumGod-li">
						<div class="PlatinumGod-All">
							...
							<div class="PlatinumGod-cont">
								<h4 class="PlatinumGod-title">旷海忘湖</h4>
