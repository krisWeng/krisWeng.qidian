	...
	<main id="boy-free">
		...
		<header>
			<ul class="boyfree-ul">
				...
				<li class="boy-free-link">
					<router-link to="/boy-free" class="boyfreenav-btn">
						男生
					</router-link>
					<router-link to="/girl-free" class="boyfreenav-btn">
						女生
					</router-link>
				</li>
				<li class="boy-free-icon">
					<!-- 搜索 -->
...
<style>*{
	...
	.boy-free-link .router-link-exact-active{
		background: #ED424B;
		color: #fff;
	}
	/* icon */
